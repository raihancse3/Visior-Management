...
<div class="row">
  <div class="col-md-12">
    ...
    <form action="{{ url('admin/role/update') }}" method="post" id="addRole" class="form-horizontal">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8">
          <input type="text" name="description" placeholder="{{ trans('message.list.description') }}" id="description" class="form-control" value="{{$role->description}}">
