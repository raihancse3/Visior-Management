  ...
  <div class="col-md-12">
    <div class="panel panel-primary" data-collapsed="0">
      <div class="panel-heading">
        <div class="panel-title">New Section Of {{$department->name}}</div>
      ...
      <div class="panel-body">
        <form action="{{ url('section/store') }}" method="post" id="locationAdd" class="form-horizontal form-groups-bordered">
